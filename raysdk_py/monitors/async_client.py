"""Asynchronous client for the RaySearch monitor-style endpoints."""
...
from .async_base import AsyncMonitorsBaseClient
...
class AsyncMonitorsClient(AsyncMonitorsBaseClient):
    """Asynchronous client for search, fetch, answer, and health operations."""

    async def healthz(self) -> HealthResponse:
        response = await self.request("/healthz", method="GET")
    ...
    async def search(
        ...
        *,
        ...
        payload = MonitorsBaseClient.build_search_request(
            query,
    ...
    async def fetch(
        ...
        *,
        ...
        payload = MonitorsBaseClient.build_fetch_request(
            urls,
    ...
    async def answer(
        ...
        *,
        ...
        payload = MonitorsBaseClient.build_answer_request(
            query,
